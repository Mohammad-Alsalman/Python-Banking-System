...
class BankingSystem():
      ...
      def selected_account_menu(self):
          ...
          if option == 1:
              ...
              self.save_data()
               ...
               amount= float(input("Entre withdraw amount: "))
               self.selected_account.withdraw(amount)
               self.save_data()
          elif option == 3:
               print("It is going back")
               return True
      ...
      def view_account_menu(self):
          try:
              while True:
                ...
                print("The option you selected does not match an account")
      ...
      def account_menu(self):
          try:
                ...
                self.show_menu(menu)
                option = int(input("Entre a number to select your option: "))
                if option ==1:
      ...
      def run_app(self):
                ...
                print ("Welcome to the bank, please log in first.")
